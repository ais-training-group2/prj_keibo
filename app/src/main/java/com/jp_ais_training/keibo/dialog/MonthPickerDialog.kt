...
import com.jp_ais_training.keibo.databinding.DialogMonthPickerBinding
import java.util.*
...
class MonthPickerDialog(context: Context): Dialog(context) {
    ...
    interface ButtonClickListener {
        fun onClicked(year: String, month: String)
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = DialogMonthPickerBinding.inflate(LayoutInflater.from(context))
