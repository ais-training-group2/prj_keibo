...
class WeekPickerDialog(context: Context): Dialog(context) {

    private lateinit var binding: DialogWeekPickerBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DialogWeekPickerBinding.inflate(LayoutInflater.from(context))
    ...
    private fun initNumberPicker() {
        ...
        val period: java.util.ArrayList<String> = getWeeksOfMonth(currentYear, currentMonth)    // 현재 연,월 값으로 주간 NumberPicker의 Display Values 추출
    ...
    private fun setNumberPickerValueChangeEvent() {
        ...
        binding.npYear.setOnValueChangedListener { picker, oldVal, newVal ->
            ...
            val period: java.util.ArrayList<String> = getWeeksOfMonth(mCurrentYear, mCurrentMonth)    // 변경된 Value로 새로운 기간 값 추출
    ...
    private fun getWeeksOfMonth(year: Int, month: Int) : java.util.ArrayList<String> {
    ...
    private fun makeWeeksOfMonthByString(calendar: Calendar, year: Int, month: Int, day: Int, weekOfMonth: Int) : java.util.ArrayList<String> {
